                            ...
                            <div class="pb-12 border-b border-gray-900/10">
                                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea id="content" name="content" rows="3" value="{{ $tasks->content }}"
                                                class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ $tasks->content }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <select id="status" name="status" autocomplete="status"
                                                class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                <option value="to_do"
                                                    {{ $tasks->status == 'to_do' ? 'selected' : '' }}>To Do
                                                </option>
                                                <option value="in_progress"
                                                    {{ $tasks->status == 'in_progress' ? 'selected' : '' }}>In Progress
                                                </option>
                                                <option value="done" {{ $tasks->status == 'done' ? 'selected' : '' }}>
                                                    Done
                                                </option>
                                            </select>
                                        </div>
